...
def main():
    ...
    parser.add_argument('--dataset_paths',
            help='list of train/val file path str([train path ,val path ,test_path])')
    parser.add_argument('--output_path', default='./results_prediction.csv',
    ...
    link_dict, test_dataset, _=from_file_list_to_tfdataset(dataset_name,path_test,return_df=True,relation_dict=link_dict)
